<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
 ...
 /*
The script uses print_r() to display the two objects; notice how print_r() displays an object’s properties in much the same way as it displays array keys and values.
 */
   						print_r( $beetle );
   						echo "</pre>";
